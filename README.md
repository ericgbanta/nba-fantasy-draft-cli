...
A CLI tool that simulatess an NBA Fantasy Draft.

### Updating Data
To scrape the latest salaryy information for this year, we've compiled a scripttt that can be run to update the `player_salaries.json` file in the `data` folder:
